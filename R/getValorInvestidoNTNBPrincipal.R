#' @title get Valor Investido Tesouro IPCA  (NTN-B Principal)
#' @description Funcao para calcular valor investido de titulo NTN-B Principal
...
#' @export
getValorInvestidoNTNBPrincipal <- function(dataCompra,
